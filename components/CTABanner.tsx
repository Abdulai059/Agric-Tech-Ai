    ...
    <section className="">
      <div className="max-w-7xl mx-auto bg-[#0a140a] my-10 py-10 md:px-6 px-4 md:px-14 md:rounded-lg">
        <div className="relative rounded-3xl overflow-hidden bg-lime px-10 md:px-16 py-16 md:py-20 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="absolute top-0 right-0 w-40 h-40 md:w-72 md:h-72 rounded-full overflow-hidden translate-x-1/3 -translate-y-1/3 pointer-events-none">
            <Image
          ...
          <div className="relative z-10 flex md:pt-20  sm:flex-row gap-3">
            <button
              className="flex items-center gap-2 bg-black text-[#b8f225] font-semibold text-sm px-6 py-2 md:py-3 rounded-full hover:bg-gray-900 transition-all duration-300 group whitespace-nowrap"
